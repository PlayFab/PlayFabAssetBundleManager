...
{	
	...
	public class AssetBundleManager : MonoBehaviour
	{
		...
		static public AssetBundleLoadManifestOperation Initialize (string manifestAssetBundleName, string urlParams = null)
		{
			...
			LoadAssetBundle(manifestAssetBundleName, true, urlParams);
		...
		static protected void LoadAssetBundle(string assetBundleName, bool isLoadingAssetBundleManifest = false, string urlParams = null)
		{
			...
			bool isAlreadyProcessed = LoadAssetBundleInternal(assetBundleName, isLoadingAssetBundleManifest, urlParams);
	
			// Load dependencies.
			if (!isAlreadyProcessed && !isLoadingAssetBundleManifest)
				LoadDependencies(assetBundleName,!string.IsNullOrEmpty(urlParams));
		}
		...
		static protected bool LoadAssetBundleInternal (string assetBundleName, bool isLoadingAssetBundleManifest, string urlParams = null)
		{
			// Already loaded.
			LoadedAssetBundle bundle = null;
			m_LoadedAssetBundles.TryGetValue(assetBundleName, out bundle);
		...
		static protected void LoadDependencies(string assetBundleName, bool isPlayFab = false)
		{
			if (m_AssetBundleManifest == null)
			{
				Debug.LogError("Please initialize AssetBundleManifest by calling AssetBundleManager.Initialize()");
		...
		static public AssetBundleLoadAssetOperation LoadAssetAsync (string assetBundleName, string assetName, System.Type type, string urlParams = null)
		{
	...
	#endif
			{
				...
				LoadAssetBundle (assetBundleName, false, urlParams);
